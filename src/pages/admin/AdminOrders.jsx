...
import { getAllOrders, updateOroder } from "../../services/order.service";
import { ADMIN_ORDER_PAGE_SIZE, formatDates, getProductImageUrl } from "../../services/helper.service";
                  ...
                  <Table bordered striped>
                    <tbody>
                      ...
                      <tr>
                        <td>Ordered Date</td>
                        <td className="fw-bold">
                          {formatDates(selectedOrder.orderedDate)}
                        </td>
                      </tr>
                      <tr>

...
import { Alert, Button, Card, Col, Container, Form, InputGroup, Pagination, Row, Table } from "react-bootstrap";
                ...
                <Form.Group className="mb-2">
                    ...
                    <InputGroup>
                       <Form.Control
                        ...
                        />
                        <Button onClick={searchUsers} variant="outline-secondary">Search</Button>
                    </InputGroup>
                </Form.Group>
                <Table
                  striped bordered responsive className="text-center">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                     {
                      user?.content?.map((users, index) => (
                        <SingleUserView key={users.userId} index={index} user={users} updateUserList={updateUserList} />
                       ))
                     }
                  </tbody>
                </Table>
    ...
    <>
      <Container fluid>
        <Row>
          <Col>
            {
              user ? userView() :<Alert><h3 className="text-center mt-2">User not Found</h3></Alert>
            }
          </Col>
        </Row>
      </Container>
